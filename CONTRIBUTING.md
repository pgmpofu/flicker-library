If you would like to contribute code to flicker-library you can do so through GitHub by forking the repository and opening a pull request against master.
